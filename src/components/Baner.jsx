    ...
    <div className="w-full h-[600px] bg-banner bg-center bg-no-repeat bg-cover relative">
      ...
      <div className="w-full h-full flex items-center justify-center space-x-[30px] p-4 relative z-20">
        ...
        <div className="w-[50%] flex items-center justify-center">
          ...
          <div className="w-[300px] h-[500px] absolute top-0 left-0 flex items-center justify-center backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-in-out">
